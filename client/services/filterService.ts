...
class FilterService {
  ...
  getFilterFields(): FilterField[] {
    return [
      ...
      // SEO Fields
      {
        ...
        type: "range",
        category: "seo",
        description: "Filter by SEO optimization score",
      },
      {
        key: "metaTitle",
        label: "Meta Title",
        type: "text",
        category: "seo",
        placeholder: "Search in meta titles...",
      },
      {
        key: "metaDescription",
        ...
        type: "text",
        category: "seo",
        placeholder: "Search in meta descriptions...",
      },
      {
        key: "focusKeyword",
        label: "Focus Keyword",
  ...
  // Filter Sharing
  async shareFilterPreset(
    id: string,
    options: { public: boolean; expiresAt?: string },
  ...
  combineFilters(
    filters1: ProductFilter[],
    filters2: ProductFilter[],
    operator: "AND" | "OR" = "AND",
  ): ProductFilter[] {
