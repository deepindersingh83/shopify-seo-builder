...
export default function InternalLinksPage() {
  ...
  const filteredLinks = internalLinks.filter((link) => {
    ...
    const matchesPosition =
      filterPosition === "all" || link.linkPosition === filterPosition;
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Manage and optimize your internal linking structure to improve SEO
              and user navigation
            </p>
          </div>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Suggest an internal link to improve your site's linking
                    structure
                  </DialogDescription>
                </DialogHeader>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {linkMetrics.totalInternalLinks.toLocaleString()}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {["content", "header", "navigation", "sidebar", "footer"].map(
                  (position) => {
                    const count = internalLinks.filter(
                      (l) => l.linkPosition === position,
                    ).length;
        ...
        <Tabs defaultValue="links" className="space-y-6">
                    ...
                    <TableBody>
                      {filteredLinks.map((link) => (
                        <TableRow key={link.id}>
                          ...
                          <TableCell>
                            <Badge
                              className={getPositionColor(link.linkPosition)}
                            >
                              {link.linkPosition}
                            </Badge>
                          ...
                          <TableCell>
                            <Badge variant="outline">{link.depth}</Badge>
                          </TableCell>
                          <TableCell>
          ...
          <TabsContent value="opportunities" className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                We've identified {linkOpportunities.length} internal linking
                opportunities that could boost your SEO performance.
              </AlertDescription>
            </Alert>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Suggested internal links to improve your site structure
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  AI-powered internal linking recommendations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg bg-blue-50">
                    ...
                    <div className="text-sm text-blue-800">
                      Based on content analysis, we recommend adding 12
                      contextual links between related blog posts and product
                      pages.
                    </div>
                  ...
                  <div className="p-4 border rounded-lg bg-green-50">
                    ...
                    <div className="text-sm text-green-800">
                      Add hub pages and topic clusters to improve your site's
                      topical authority and link equity distribution.
                    </div>
                    <Button size="sm" className="mt-2" variant="outline">
                      Create Hub Pages
                    </Button>
          ...
          <TabsContent value="orphans" className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                You have {linkMetrics.orphanPages} orphan pages with no internal
                links pointing to them. These pages may not be discovered by
          ...
          <TabsContent value="analysis" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    How deep your pages are from the homepage
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {[1, 2, 3, 4, 5, 6].map((depth) => {
                      ...
                      const percentage =
                        count > 0 ? (count / internalLinks.length) * 100 : 0;
                      return (
                        <div key={depth} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span>Level {depth}</span>
                            <span>
                              {count} pages ({percentage.toFixed(1)}%)
                            </span>
                          </div>
                          <Progress value={percentage} className="h-2" />
                        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center space-y-4">
                    ...
                    <div className="text-xs text-muted-foreground">
                      A score above 70% indicates well-distributed link equity
                      across your site structure.
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Suggestions to improve your internal link structure
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 border rounded-lg">
                    <div className="flex items-center mb-2">
                      <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                      <span className="font-medium text-green-900">
                        Good: Flat Site Architecture
                      </span>
                    </div>
                    <div className="text-sm text-muted-foreground">
                      Most of your pages are within 3 clicks from the homepage,
                      which is excellent for SEO.
                    </div>
                  </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-medium text-orange-900">
                        Improve: Add Contextual Links
                      </span>
                    </div>
                    <div className="text-sm text-muted-foreground">
                      Add more contextual links within your blog content to
                      distribute link equity more effectively.
                    </div>
                  </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {linkMetrics.orphanPages} pages have no internal links
                      pointing to them and need attention.
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="settings" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure how internal links are tracked and analyzed
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="min-equity">
                        Minimum Link Equity Threshold
                      </Label>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  URLs or patterns to exclude from internal link analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
