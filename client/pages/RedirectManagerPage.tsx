...
export default function RedirectManagerPage() {
  ...
  const filteredRedirects = redirects.filter((redirect) => {
    ...
    const matchesStatus =
      filterStatus === "all" || redirect.status === filterStatus;
    const matchesType =
      filterType === "all" || redirect.redirectType === filterType;
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Manage URL redirects to maintain SEO value when changing URLs and
              prevent 404 errors
            </p>
          </div>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Create a new URL redirect to maintain SEO value and user
                    experience
                  </DialogDescription>
                </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {redirectStats.totalHits.toLocaleString()}
              </div>
              <div className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {redirectStats.averageResponseTime}ms
              </div>
              <div className="text-xs text-muted-foreground">
                Average response
              </div>
        ...
        <Tabs defaultValue="redirects" className="space-y-6">
          ...
          <TabsContent value="redirects" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  URL Redirects ({filteredRedirects.length})
                </CardTitle>
                <CardDescription>
                    ...
                    <TableBody>
                      {filteredRedirects.map((redirect) => (
                        <TableRow key={redirect.id}>
                          ...
                          <TableCell>
                            <Badge
                              className={getRedirectTypeColor(
          ...
          <TabsContent value="errors" className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                You have {redirectStats.errorRedirects} redirects with errors
                that need immediate attention. These may be causing 404 errors
                or infinite redirect loops.
              </AlertDescription>
            </Alert>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Redirects that are not working correctly
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="bulk-import" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Import multiple redirects from CSV or paste data directly
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Pre-built templates for common redirect scenarios
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {[
                    {
                      ...
                      template:
                        "/*,https://newdomain.com/*,301,Domain migration",
                    },
                    {
                      name: "HTTPS Migration",
                      description: "Redirect HTTP to HTTPS",
                      template:
                        "http://domain.com/*,https://domain.com/*,301,HTTPS migration",
                    },
                    {
                      name: "Page Restructure",
                      description: "Redirect old page structure to new",
                      template:
                        "/old-section/*,/new-section/*,301,Site restructure",
                    },
                    {
                      name: "Blog Migration",
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Redirects with the most traffic
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {["301", "302", "307", "308"].map((type) => {
                      const count = redirects.filter(
                        (r) => r.redirectType === type,
                      ).length;
                      ...
                      return (
                        <div key={type} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span>
                              {type}{" "}
                              {getRedirectTypeDescription(type).split(" - ")[1]}
                            </span>
                            <span>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Key performance indicators for your redirects
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="settings" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Advanced redirect rules and patterns
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
