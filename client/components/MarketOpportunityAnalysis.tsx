    ...
    try {
      ...
      const mockCompetitors: CompetitorAnalysis[] = [
        ...
        },
        {
          ...
          pricing: {
            avg_price: 78.45,
            price_range: { min: 25.0, max: 349.99 },
        ...
        <Dialog open={showAnalysisDialog} onOpenChange={setShowAnalysisDialog}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Analyze a specific market segment or product category for
                opportunities.
              </DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              $
              {Math.round(
                (opportunities.reduce((sum, o) => sum + o.estimatedRevenue, 0) /
                  1000000) *
                  10,
              ) / 10}
              M
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {productGaps.reduce(
                (sum, gap) => sum + gap.missingProducts.length,
                0,
              )}
            </div>
            <p className="text-xs text-muted-foreground">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">
                      {opportunity.category} • Market Size: $
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-medium">
                          ${(opportunity.estimatedRevenue / 1000000).toFixed(1)}
                          M
                        </div>
                      </div>
                      <div>
                  ...
                  <div className="flex space-x-6 text-sm">
                    <div>
                      ...
                      <span className="ml-2 font-medium">
                        {opportunity.seasonality.peak_months.join(", ")}
                      </span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Low:</span>
                      <span className="ml-2 font-medium">
                        {opportunity.seasonality.low_months.join(", ")}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <Card key={gap.id}>
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold">
                      {gap.category} Product Gaps
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {gap.missingProducts.length} opportunities • $
                      {(gap.totalOpportunity / 1000).toFixed(0)}K potential
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <div className="font-medium">
                            {product.estimatedDemand.toLocaleString()}/month
                          </div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">
                          ...
                          <div className="font-medium">
                            {product.keywordVolume.toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <span className="text-muted-foreground">
                ...
                <div className="mt-4 pt-4 border-t flex justify-between items-center">
                  <div className="text-sm">
                    ...
                    <span className="ml-2 font-medium">
                      ${gap.requiredInvestment.toLocaleString()}
                    </span>
                  </div>
                  <Button size="sm">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {competitor.seo_performance.domain_authority}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">
                        ...
                        <span className="font-medium">
                          #{competitor.seo_performance.avg_ranking}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our AI has detected a 67% increase in searches for
                    "sustainable electronics" over the past 30 days. This
                    presents a significant opportunity in the Electronics
                    category with low competition and high profit potential.
                  </p>
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Based on historical data and current trends, we predict a
                    45% spike in "home fitness equipment" searches starting in
                    December. Consider preparing inventory and SEO campaigns
                    now.
                  </p>
                  <Button size="sm" className="mt-2" variant="outline">
                ...
                <div className="border-l-4 border-yellow-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your top competitor has weak coverage in the "eco-friendly
                    fashion accessories" segment. This represents a $2.3M
                    revenue opportunity with 78% confidence.
                  </p>
                  <Button size="sm" className="mt-2" variant="outline">
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The keyword "smart home security" has 89K monthly searches
                    with only 23% competition. Creating content around this
                    topic could capture significant organic traffic.
                  </p>
                  <Button size="sm" className="mt-2" variant="outline">
