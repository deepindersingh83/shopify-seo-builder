...
export function DataSources() {
          ...
          enrichedFields: [
            {
              ...
              enrichedValue:
                "Advanced professional-grade device with premium specifications and industry-leading performance metrics...",
              confidence: 0.94,
              source: "Icecat",
            },
            {
              ...
              originalValue: "",
              enrichedValue:
                "Dimensions: 15.2 x 10.1 x 2.3 cm, Weight: 450g, Material: Aluminum alloy...",
              confidence: 0.89,
              source: "Icecat",
            },
          ],
  ...
  const handleSync = async (sourceId: string) => {
    try {
      setActiveSyncs((prev) => ({
        ...prev,
        [sourceId]: { status: "running", progress: 0 },
      }));
  ...
  const getSourceName = (type: string) => {
    switch (type) {
      case "icecat":
        return "Icecat Product Database";
      case "google_merchant":
        return "Google Merchant Center";
      case "amazon_api":
        return "Amazon Product API";
      case "alibaba":
        return "Alibaba Product Data";
      case "shopify_exchange":
        return "Shopify Product Exchange";
      default:
        return "Custom API";
    }
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Connect to product databases and enrich your catalog
          </p>
        </div>
        <Dialog open={showConnectDialog} onOpenChange={setShowConnectDialog}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Choose a data source and enter your credentials to start
                enriching products.
              </DialogDescription>
            </DialogHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dataSources
                .reduce((sum, s) => sum + s.stats.enrichedProducts, 0)
                .toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {Math.round(
                dataSources.reduce((sum, s) => sum + s.stats.successRate, 0) /
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dataSources.filter((s) => s.settings.autoSync).length}
            </div>
            <p className="text-xs text-muted-foreground">
                  ...
                  <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">
                        {source.stats.totalProducts.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Enriched:</span>
                      <p className="font-medium">
                        {source.stats.enrichedProducts.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <span className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  Connect to product databases like Icecat to automatically
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enriched {enrichment.enrichedFields.length} fields
                          from{" "}
                          {enrichment.sourceId === "1"
                            ? "Icecat"
                            : "Unknown Source"}
                        </p>
                      </div>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                            <div>
                              ...
                              <p className="mt-1 p-2 bg-red-50 rounded">
                ...
                {[
                  {
                    name: "Icecat",
                    type: "icecat",
                    description: "Global product catalog with 12M+ products",
                    price: "Premium",
                    rating: 4.8,
                  },
                  {
                    name: "Google Merchant Center",
                    type: "google_merchant",
                    description: "Product data from Google Shopping",
                    price: "Free",
                    rating: 4.6,
                  },
                  {
                    name: "Amazon Product API",
                    type: "amazon_api",
                    description: "Access Amazon product database",
                    price: "Paid",
                    rating: 4.4,
                  },
                  {
                    name: "Alibaba Open Platform",
                    type: "alibaba",
                  ...
                  {
                    name: "Shopify Product Exchange",
                    type: "shopify_exchange",
                    description: "Product data from Shopify ecosystem",
                    price: "Free",
                    rating: 4.5,
                  },
                  {
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Badge
                          variant={
                            source.price === "Free" ? "secondary" : "outline"
                          }
                        >
                          {source.price}
                        </Badge>
...
function ConnectDataSourceForm({
  onConnect,
  onCancel,
}: {
      ...
      {sourceType === "custom_api" && (
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              value={credentials.authMethod || "api_key"}
              onValueChange={(value) =>
                setCredentials({ ...credentials, authMethod: value })
              }
            >
              <SelectTrigger>
                <SelectValue />
